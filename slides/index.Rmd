---
title: "MacKin xaringan template"
subtitle: "Because only n00bs use powerpoint or keynote"
author: "Mike Carter"
...
- We can also make `blockquotes`
  - we can use `<mackin-blockquote>text</mackin-blockquote>` 
  - or `>`

<mackin-blockquote>This is a blocked quote</mackin-blockquote>
...
---
background-image: url(https://raw.githubusercontent.com/cartermaclab/mackin-xaringan/main/imgs/logos/mackin-stack-color.png)
...
We can do this with white, .grey[grey], .black[black], .mackinred[red] and .blue[blue]. 
...
- For example, if we put the following code into `macros.js` or another name like `mackin-xaringan.js`...
...
```md
![:scale 10%](../imgs/logos/mcmaster-color.png)
```
...
- All we need to do is include `beforeInit: "mackin-xaringan.js"` under nature in our YAML front matter
...
- We can create section dividers with MacKin red and grey by using the `class` call:
